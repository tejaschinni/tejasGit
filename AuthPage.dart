...
import 'package:my_app/Maintain/addAdminPage.dart';
...
class _AuthPageState extends State<AuthPage> {
  ...
  void isAdminRegistered() {
    print('isAdminRegistered method called');
    setState(() {
      processing = true;
    ...
    Firestore.instance
      ...
      if (doc.exists) {
        ...
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => AddAdminPage()));
      }
    });
